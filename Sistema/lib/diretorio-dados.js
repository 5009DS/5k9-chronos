  ...
  "fases": [
    {
      ...
      "tom": ["direto", "assertivo", "orientado a resultado"],
      ...
      "palavras_chave": [
        "agende", "vagas limitadas", "garanta seu lugar", "inscreva-se",
        "antes e depois", "resultado real", "depoimento", "lançamento",
        "últimas vagas", "não perca"
      ],
      "formatos": ["prova social/depoimento", "campanha institucional", "lançamento de protocolo/evento"],
      "cta_exemplos": ["Agende sua consulta", "Garanta sua vaga", "Inscreva-se agora"],
    ...
    },
    {
      ...
      "tom": ["técnico traduzido em linguagem acessível", "educativo", "explicativo"],
      "sinais_classificacao": [
      ...
      "palavras_chave": [
        "entenda como", "por que acontece", "causas", "sintomas",
        "bastidores", "diagnóstico", "planejamento", "protocolo explicado",
        "você sabia que"
      ],
      "formatos": ["explicação de patologia", "bastidores de protocolo", "diagnóstico e planejamento médico"],
      "cta_exemplos": ["Saiba mais", "Entenda como funciona", "Comenta aqui sua dúvida"],
    ...
    },
    {
      ...
      "tom": ["leve", "dinâmico", "relacionável", "fácil consumo"],
      "sinais_classificacao": [
      ...
      "palavras_chave": [
        "mito ou verdade", "dica rápida", "no dia a dia", "salve esse post",
        "marque alguém", "você sabia", "hidratação", "rotina saudável"
      ],
      "formatos": ["mitos e verdades", "dicas de rotina", "conteúdo relacionável"],
      "cta_exemplos": ["Salve para depois", "Marque alguém que precisa ver isso", "Compartilhe"],
...
export const OBJETIVOS = {
  ...
  "como_o_sistema_usa": "Cada conteúdo carrega uma fase e um objetivo. O visualizador cruza os dois e mostra automaticamente: a explicação do objetivo, a leitura do par (se a combinação é natural, se exige cuidado ou se está em conflito) e o que medir depois de publicar. Nada é gerado por modelo de linguagem — tudo sai deste arquivo, e por isso pode ser conferido e corrigido à mão.",
